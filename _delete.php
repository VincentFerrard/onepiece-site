<form action="interactionDelete.php" method="POST">
	    <table style="background-color:blue;width:25%">
		 ...
		 <!--Cinquième ligne-->
		 <tr>
		   <td> <input style="margin-top:8px;margin-bottom:8px;margin-left:150px;color:black" type="submit" value="Supprimer" onclick="delete()" /> </td>
		 </tr>
	   </tbody>
	  </table>
</form>